...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Luxuriously creamy goat milk soap blended with organic aloe vera. Soothes, repairs, and deeply nourishes dry or irritated skin.",
    priceCents: 2800,
    compareAtPriceCents: 3200,
    ingredients: ["Goat Milk", "Aloe Barbadensis Leaf Juice", "Sodium Olivate", "Sodium Cocoate", "Butyrospermum Parkii Butter", "Colloidal Oatmeal"],
