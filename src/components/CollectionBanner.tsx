...
export default function CollectionBanner({ name, tagline, imageUrl, href }: CollectionBannerProps) {
  ...
  return (
    <section className="relative h-[50vh] min-h-100 overflow-hidden bg-foreground group">
      <motion.div
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
          <div className="max-w-lg space-y-4">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl font-bold text-background text-balance">
              {name}
            </h1>
            <p className="text-base sm:text-lg text-accent-subtle/80 font-serif italic text-pretty pr-4">
              {tagline}
            </p>
            <motion.div
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 bg-accent-strong opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300" />
