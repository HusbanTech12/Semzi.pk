  ...
  return (
    <section className="py-24 lg:py-32 bg-background">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <Reveal delay={0.1}>
          <Link href="/collections/beach" className="group relative block aspect-[4/5] overflow-hidden rounded-2xl border border-border/50 bg-surface-muted transition-all duration-500 hover:border-accent/30 sm:aspect-[16/9] lg:aspect-[21/9]">
            <Image
